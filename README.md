...
| mp_roundover                       | 0       | 0   | 3            | The round by expired time will be over, if on a map it does not have the scenario of the game.<br/>`0` disabled<br/>`1` round end with Terrorists win<br/>`2` round end with Counter-Terrorists win<br/>`3` end of the round with a draw |
