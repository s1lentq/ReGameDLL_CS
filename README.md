...
| mp_smoke_thickness	             | 1       | 1   | 5            | Smoke thickness effect when SG grenade explode. <br/>`1` 1 smoke grenade "Default" <br/>`2` 2 smoke grenades <br/>`3` 3 smoke grenades <br/>`4` 4 smoke grenades <br/>`5` 5 smoke grenades <br/>`NOTE`: Not recomended for clients with old hardware. |
