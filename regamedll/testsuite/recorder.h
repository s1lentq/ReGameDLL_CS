...
public:
	...
	int getRegamedllCallbackId() { return m_Id; }
...
class CRecordingEngExtInterceptor : public IReGameDLLPlatform {
...
private:
	...
	IReGameDLLPlatform* m_BasePlatform;

public:
	CRecordingEngExtInterceptor(const char* fname, IReGameDLLPlatform* basePlatform);
